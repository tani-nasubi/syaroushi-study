...
.wrap{max-width:182mm; margin:0 auto; padding:10mm 6mm}
/* ── 巻頭 ── */
...
.howto{margin:16mm auto 0; max-width:130mm; text-align:left;
...
.toc .grp{margin:5mm 0 2mm; font-weight:700; font-size:10.5pt;
...
.doc > .head{border-bottom:1.6pt solid #111; padding-bottom:2.5mm; margin:0 0 5mm}
...
h2{font-size:12pt; margin:7mm 0 2.5mm; padding:1mm 0 1mm 3mm;
  border-left:3.5pt solid #111; break-after:avoid; page-break-after:avoid}
h3{font-size:10.6pt; margin:5mm 0 2mm; padding-bottom:.8mm;
  border-bottom:.6pt solid #ccc; break-after:avoid; page-break-after:avoid}
h4{font-size:9.8pt; margin:4mm 0 1.5mm; break-after:avoid; page-break-after:avoid}
p{margin:0 0 2.4mm}
...
hr{border:0; border-top:.6pt solid #ddd; margin:5mm 0}
...
<div class="bar">
  ...
  <span>A4縦・{len(pages)}資料。ブラウザの印刷から「背景のグラフィック」を入にすると表の罫線がきれいに出ます。</span>
</div>
